...
import org.ravine.core.server.cluster.ClusterServiceGrpc.ClusterServiceFutureStub;
...
public class ClusterConnectionPool {
  ...
  public static class Channel {
    ...
    private ClusterServiceFutureStub mStub;

    private Channel(final ManagedChannel managedChannel) {
      mManagedChannel = managedChannel;
      mStub = ClusterServiceGrpc.newFutureStub(managedChannel);
    }
