...
class StreamConverterDecorator<Source, Target>(
    private val targetObserver: StreamObserver<Target>,
    private val converter: Converter<Source, Target>
) : StreamObserver<Source> {
