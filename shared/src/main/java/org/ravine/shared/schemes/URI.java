 ...
 *
 * e.g URI = ravine://<host>:<port>
 */
public class URI {

  /**
   * Default Ravine URI scheme. Serves no real purpose apart from some
   * visibility to users for Ravine related URIs.
   */
  public static final String SCHEME = "ravine://";
